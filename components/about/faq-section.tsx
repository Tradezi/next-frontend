...
const FAQItem = ({
  ...
  return (
    <div className="border-b border-gray-200 py-3 sm:py-4 dark:border-gray-700">
      <button
        className="flex w-full items-center justify-between text-left text-sm font-medium text-gray-900 sm:text-base dark:text-gray-100"
...
export default function FAQSection() {
  return (
    <section>
      <h3 className="mb-3 text-xl font-semibold text-gray-900 sm:mb-6 sm:text-2xl dark:text-white">
